...
Adafruit_BNO055::Adafruit_BNO055(int32_t sensorID, uint8_t address, const std::string &i2c_name)
{
  _sensorID = sensorID;
  i2c_dev = new I2CBusRaspberryPi4(i2c_name, address);
}

Adafruit_BNO055::~Adafruit_BNO055()
{
  if (this->i2c_dev != nullptr)
  {
    delete this->i2c_dev;
  }
}
